...
;適宜変更のこと
	...
	ORG	DBUG
	JP	START
PIOACD:	DB	4FH	;PIOAモードワード			**001111 (入力モード)
;	DB	00H	;PIOAデータディレクションワード (未使用)
	DB	03H	;PIOAインタラプトコントロールワード	****0011 (割込み無効)
;	DB	17H	;PIOAインタラプトコントロールワード	****0111 (未使用)
;	DB	00H	;PIOAインタラプトマスクワード (未使用)
;	DB	0E4H	;PIOAインタラプトベクタ (未使用)
PAEND	EQU	$
PIOBCD:	DB	0FH	;PIOBモードワード			**001111 (出力モード)
;	DB	00H	;PIOBデータディレクションワード (未使用)
	DB	03H	;PIOBインタラプトコントロールワード	****0011 (割込み無効)
